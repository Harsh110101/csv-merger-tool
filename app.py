...
def parse_salesgenie(df):
    return pd.DataFrame({
        ...
        "Founding Year": df.get("Primary SIC Year Appeared") or df.get("Year Established"),
        "Facebook URL": "",
        "LinkedIn URL": "",
        "Twitter URL": "",
        ...
        "Employees": df.get("Location Number of Employees") or df.get("Location Employee Size Actual"),
        "Industry": df.get("Primary NAICS Description"),
